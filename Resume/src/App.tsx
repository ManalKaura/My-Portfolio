...
import OrangeNoiseBackground from './components/ui/background-snippets-noise-effect11';
import CyanGridNoiseBackground from './components/ui/cyan-grid-noise-background';
    ...
    <div className="relative min-h-screen text-slate-100 selection:bg-orange-500 selection:text-white font-sans antialiased overflow-x-hidden">
      ...
      >
        <div className="flex items-center justify-between gap-3 p-3 rounded-2xl bg-slate-950/75 border border-slate-800/80 backdrop-blur-xl shadow-2xl shadow-black/60">
          ...
          {/* Logo with interactive letter swap */}
          <a
            href="#intro"
            className="flex items-center gap-2.5 pl-2 font-bold text-white tracking-tight group"
          >
          ...
          <div className="hidden md:block">
            <RandomLetterSwapNav
              items={[
                ...
                { label: "Resume", href: "#resume-content" },
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="#contact"
              className="px-3.5 py-1.5 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-semibold text-xs transition shadow-lg shadow-orange-500/25 flex items-center gap-1.5"
            >
      ...
      >
        ...
        <section id="hero" className="scroll-mt-32">
          ...
          >
            <Card3D
              className="p-8 sm:p-12 border-orange-500/30 shadow-[0_0_50px_-15px_rgba(249,115,22,0.2)]"
                ...
                <div className="flex-1 text-center lg:text-left space-y-4">
                  ...
                  <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 pt-2 text-xs">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-950/70 hover:bg-slate-800 border border-slate-800 text-slate-300 transition"
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-950/70 hover:bg-slate-800 border border-slate-800 text-slate-300 transition font-mono"
        ...
        <section id="projects" className="scroll-mt-28">
          ...
          >
            ...
            <div className="space-y-8">
              ...
              {/* Project 1: 3D Cube Runner Game with Screenshot #1 */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  ...
                  <div className="lg:col-span-6 space-y-4">
                    ...
                    <a
                      ...
                      className="text-2xl sm:text-3xl font-black text-white tracking-tight hover:text-orange-400 transition-colors flex items-center gap-2.5 group cursor-pointer"
                      title="Open 3D Cube Runner live website"
                    >
                    ...
                    <div className="pt-2 flex flex-wrap items-center gap-3">
                      <a
                        ...
                        title="Launch 3D Cube Runner interactive website"
                      >
                        <Gamepad2 className="w-3.5 h-3.5 text-white animate-pulse" />
                        <span>Launch 3D Cube Runner Site</span>
                  ...
                  {/* 1st Uploaded Image: Unity 3D Cube Runner Game Screenshot (Clickable) */}
                  <div className="lg:col-span-6">
                    <a
                      ...
                      title="Click to launch 3D Cube Runner website"
                    >
              ...
              <Card3D className="p-8 border-cyan-500/30" glowColor="rgba(34, 211, 238, 0.25)" depth={15}>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  ...
                  <div className="lg:col-span-6 space-y-4">
                    ...
                    <div className="pt-2 flex flex-wrap items-center gap-3">
                      <a
                        href="http://localhost:5173/#/smart-notes"
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-cyan-500 hover:bg-cyan-600 text-slate-950 font-bold text-xs transition shadow-lg shadow-cyan-500/20 hover:scale-105"
                        title="Explore Smart Notes interactive webpage"
                      >
                        <Smartphone className="w-3.5 h-3.5 text-slate-950" />
                        <span>Launch Notes Webpage</span>
                        <ExternalLink className="w-3 h-3" />
                      </a>
                      ...
                      <a
                        ...
                        title="Launch standalone Smart Notes site"
                      >
                  ...
                  {/* Smart Notes Application Screenshot (Clickable) */}
                  <div className="lg:col-span-6">
                    <a
                      href="http://localhost:5173/#/smart-notes"
                      target="_blank"
        ...
        {/* ================= FOOTER ================= */}
        <footer className="text-center text-xs text-slate-500 py-10 border-t border-slate-900/80 space-y-2">
          <p>© {new Date().getFullYear()} Manal Kaura. Built with React, TypeScript, Tailwind CSS & Framer Motion.</p>
