...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Manal Kaura</span> <span className="text-primary/70 text-base">✦</span>
    <span>Thapar Institute of Engineering &amp; Technology</span> <span className="text-secondary/70 text-base">✦</span>
    <span>Computer Engineering</span> <span className="text-primary/70 text-base">✦</span>
  </div>
);
...
export function CinematicFooter({ onNavigateResume, onNavigateProjects }: CinematicFooterProps = {}) {
      ...
      */}
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                <MagneticButton
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground flex items-center gap-2.5 transition-colors group"
                >
                  <svg className="w-4 h-4 fill-current text-muted-foreground group-hover:text-[#0A66C2] transition-colors" viewBox="0 0 24 24">
                ...
                <MagneticButton
                  ...
                  className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground flex items-center gap-2.5 transition-colors group"
                >
                  <svg className="w-4 h-4 fill-current text-muted-foreground group-hover:text-foreground transition-colors" viewBox="0 0 24 24">
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 items-center gap-4">
            ...
            <div className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest uppercase text-center md:text-left order-2 md:order-1">
              © {new Date().getFullYear()} Manal Kaura. All rights reserved.
            </div>

            {/* "Made with Love" Badge - Perfectly Centered */}
            <div className="flex justify-center order-1 md:order-2">
              <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 cursor-default border-border/50">
                ...
                <span className="text-foreground font-black text-xs md:text-sm tracking-normal ml-1">Manal Kaura</span>
              </div>
            </div>
